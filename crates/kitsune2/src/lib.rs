...
/// - `block` - The default block module is [factories::MemBlockFactory].
///             Note: you will likely want to implement your [`Block`] module.
pub fn default_builder() -> Builder {
    Builder {
        ...
        block: factories::MemBlockFactory::create(),
    }
}
