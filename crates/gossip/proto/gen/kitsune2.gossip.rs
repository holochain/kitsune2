...
pub struct K2GossipProto {
    #[prost(oneof = "k2_gossip_proto::GossipMessage", tags = "1, 2")]
    pub gossip_message: ::core::option::Option<k2_gossip_proto::GossipMessage>,
}
/// Nested message and enum types in `K2GossipProto`.
pub mod k2_gossip_proto {
    #[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum GossipMessage {
        /// A gossip initiation protocol message.
        #[prost(message, tag = "1")]
        Initiate(super::K2GossipInitiateProto),
        /// A gossip acceptance protocol message.
        #[prost(message, tag = "2")]
        Accept(super::K2GossipAcceptProto),
    }
}
/// A Kitsune2 gossip initiation protocol message.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct K2GossipInitiateProto {
    /// The agents from the initiator who are participating in this gossip round.
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct K2GossipAcceptProto {
    /// The agents from the initiator who are participating in this gossip round.
    #[prost(bytes = "bytes", repeated, tag = "1")]
    pub participating_agents: ::prost::alloc::vec::Vec<::prost::bytes::Bytes>,
    /// Agents that were mentioned in the initiator's participating_agents list
