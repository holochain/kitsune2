...
/// A single op entry in a publish ops message.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct PublishOpEntry {
    /// Op id.
    #[prost(bytes = "bytes", tag = "1")]
    pub op_id: ::prost::bytes::Bytes,
    /// Optional host-supplied metadata.
    #[prost(bytes = "bytes", optional, tag = "2")]
    pub metadata: ::core::option::Option<::prost::bytes::Bytes>,
}
...
pub struct PublishOps {
    ...
    pub entries: ::prost::alloc::vec::Vec<PublishOpEntry>,
}
