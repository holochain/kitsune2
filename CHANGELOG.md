...
- Give test `two_node_gossip` more time to sync on CI
...
- Update to the latest tx5 release which includes a bugfix for handling p2p connection setup failures
