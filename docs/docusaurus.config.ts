...
const config: Config = {
  ...
  organizationName: 'holochain', // Usually your GitHub org/user name.
  projectName: 'kitsune2', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/holochain/kitsune2/tree/main/docs/docs/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Holochain Foundation. Built with Docusaurus.`,
    },
    prism: {
